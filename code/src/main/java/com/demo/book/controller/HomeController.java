...
public class HomeController {
    ...
    public HomeController(UserService userService, BookService bookService, CartItemService cartItemService, OrderService orderService, BulletinService bulletinService, CommentService commentService) {
